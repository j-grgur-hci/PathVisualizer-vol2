        ...
        if (target.id === "3") {
          ...
          pseudo1.appendChild(
            document.createTextNode(
              "Svi čvorovi se označuju kao neposjećeni te se stvori lista istih"
            )
          )
          ...
          pseudo2.appendChild(
            document.createTextNode(
              "Inicijaliziraju se udaljenosti čvorova, pri čemu se udaljenost početnog čvora postavi na nulu, a udaljenost preostalih čvorova na beskonačno (oznaka da nisu posjećeni)"
            )
          )
          ...
          pseudo3.appendChild(
            document.createTextNode(
              "Izračunava se udaljenost susjednih čvorova trenutnog čvora"
            )
          )
          ...
          pseudo4.appendChild(
            document.createTextNode(
              "Trenutni čvor se označava kao posjećen i miče se iz liste neposjećenih (posjećeni čvor se više nikad neće provjeriti)"
            )
          )
          ...
          pseudo5.appendChild(
            document.createTextNode(
              "Ako je odredišni čvor označen kao posjećen ili ako je najmanja udaljenost između čvorova u neposjećenom skupu beskonačna tada je algoritam gotov"
            )
          )
          ...
          pseudo6.appendChild(
            document.createTextNode(
              "Ukoliko algoritam nije gotov, odabire se neposjećeni čvor sa najmanjom udaljenošću te se postavi kao novi trenutni čvor  i vraća se natrag na 3.korak"
            )
          )
          ...
          document.getElementById("h5v_slozenost").innerHTML =
            "Vremenska složenost je pri tome O (V)."
          const ul = document.getElementById("ul_primjena")
          const li = document.createElement("li")
          li.appendChild(
            document.createTextNode(
              "Google Maps -Postoji mnogi broj različitih puteva između dvije geografske lokacije, no Dijkstrin algoritam   omogućava da se pronađe najkraći od tih puteva. Primjerice, put Split – Beč koji se mogu promatrati kao dva čvora, a moguće puteve između te dvije lokacije kao rubove"
            )
          )
          ul.appendChild(li)
          ...
          li1.appendChild(
            document.createTextNode(
              "Društvene mreže – Koristi se za listu predloženih prijatelja koje bi korisnik mogao znati, a radi na osnovu različitih poveznica između korisnika"
            )
          )
          ul.appendChild(li1)
          ...
          li2.appendChild(
            document.createTextNode(
              "Plan leta – Kada zaposlenik treba za klijenta odrediti letove s kojima će u najkraćem vremenskom roku doći do željenog odredišta"
            )
          )
          ul.appendChild(li2)
          ...
          li3.appendChild(
            document.createTextNode(
              "IP usmjeravanje za pronalaženje najprije otvorenog najkraćeg puta – Najprije otvoren najkraći put je protokol koji se koristi kako bi se pronašao najbolji put između izvora i odredišnog routera koji koristi najkraći put "
            )
          )
          ul.appendChild(li3)
        } else if (target.id === "4") {
          ...
          pseudo1.appendChild(
            document.createTextNode(
              "Inicijalizira se lista posjećenih i neposjećenih čvorova"
            )
          )
          pseudo_list.appendChild(pseudo1)
          const pseudo2 = document.createElement("li")
          pseudo2.appendChild(
            document.createTextNode(
              "Čvor sa najmanjim F troškom se premješta iz liste neposjećenih u listu posjećenih  čvorova"
            )
          )
          pseudo_list.appendChild(pseudo2)
          const pseudo3 = document.createElement("li")
          pseudo3.appendChild(
            document.createTextNode(
              "Ako se susjed trenutnog čvora ne nalazi u neposjećenoj listi  izračunava se F vrijednost te se dodaje u listu"
            )
          )
          pseudo_list.appendChild(pseudo3)
          const pseudo4 = document.createElement("li")
          pseudo4.appendChild(
            document.createTextNode(
              "Ako susjedni čvor se nalazi u listi posjećenih čvorova, ignorira se"
            )
          )
          pseudo_list.appendChild(pseudo4)
          const pseudo5 = document.createElement("li")
          pseudo5.appendChild(
            document.createTextNode(
              "Ako se susjedni čvor nalazi u listi neposjećenih, uspoređuje se F vrijednost trenutnog čvora i preostalih susjednih čvorova te ukoliko je manja"
            )
          )
          pseudo_list.appendChild(pseudo5)
          // document.getElementById("h5_primjer").innerHTML = ""
          ...
          li.appendChild(
            document.createTextNode(
              "Videoigre – A* algoritam je široko upotrebljavan za rješavanje problema pronalaženja puta"
            )
          )
          ul.appendChild(li)
          const li1 = document.createElement("li")
          li1.appendChild(
            document.createTextNode("Optimizacija pretraživanja ")
          )
          ul.appendChild(li1)
          const li2 = document.createElement("li")
          ...
          pseudo1.appendChild(
            document.createTextNode(
              "Odabere se početni čvor te se stave njegovi susjedi na vrh"
            )
          )
          pseudo_list.appendChild(pseudo1)
          const pseudo2 = document.createElement("li")
          pseudo2.appendChild(
            document.createTextNode(
              "Skida se čvor sa vrha stoga te ga se stavlja u listu posjećenih čvorova"
            )
          )
          pseudo_list.appendChild(pseudo2)
          const pseudo3 = document.createElement("li")
          pseudo3.appendChild(
            document.createTextNode(
              "Susjedi tog čvora koji se ne nalaze u listi posjećenih čvorova potom se stavljaju na vrh stoga                                                                                      "
            )
          )
          pseudo_list.appendChild(pseudo3)
          const pseudo4 = document.createElement("li")
          pseudo4.appendChild(
            document.createTextNode(
              "Ponavlja se 2. i 3. korak dok stog ne bude prazan "
            )
          )
          pseudo_list.appendChild(pseudo4)
          ...
          document.getElementById("h5v_slozenost").innerHTML =
            "Vremenska složenost je O(V) + O(E) = O(V + E)"
          const ul = document.getElementById("ul_primjena")
          const li = document.createElement("li")
          li.appendChild(
            document.createTextNode(
              "Rješavanje zagonetki poput labirinta i sudoku-a"
            )
          )
          ul.appendChild(li)
          const li1 = document.createElement("li")
          ...
          li2.appendChild(
            document.createTextNode(
              "Mapiranje ruta i analiza mreže(primjerice testiranje je li graf bipartitan)"
            )
          )
          ul.appendChild(li2)
          const li3 = document.createElement("li")
          ...
          pseudo1.appendChild(
            document.createTextNode(
              "Odabere se početni čvor te se stavi na početak reda"
            )
          )
          pseudo_list.appendChild(pseudo1)
          const pseudo2 = document.createElement("li")
          pseudo2.appendChild(
            document.createTextNode(
              "Čvor s početka reda se skine te se doda listi posjećenih čvorova"
            )
          )
          pseudo_list.appendChild(pseudo2)
          const pseudo3 = document.createElement("li")
          pseudo3.appendChild(
            document.createTextNode(
              "Stvara se lista susjednih čvorova te se u nju dodaju oni susjedi koji nisu posjećeni "
            )
          )
          pseudo_list.appendChild(pseudo3)
          const pseudo4 = document.createElement("li")
          pseudo4.appendChild(
            document.createTextNode(
              "Ponavlja se 2. i 3.korak dok red nije prazan "
            )
          )
          pseudo_list.appendChild(pseudo4)
          ...
          li.appendChild(
            document.createTextNode(
              "GPS navigacijski sustav- za pronalaženje susjednih lokacija s određenog izvornog  mjesta"
            )
          )
          ul.appendChild(li)
          const li1 = document.createElement("li")
          li1.appendChild(
            document.createTextNode(
              "Društvene mreže- može se pronaći broj ljudi na određenoj udaljenosti ‘k’ od osobe "
            )
          )
          ul.appendChild(li1)
          const li2 = document.createElement("li")
          li2.appendChild(
            document.createTextNode(
              "P2P (Peer to Peer) mreže -mreže poput BitTorrent-a koriste BFS za pronalaženje svih susjednih čvorova određenog čvora"
            )
          )
          ul.appendChild(li2)
          const li3 = document.createElement("li")
          li3.appendChild(
            document.createTextNode(
              "Pauci za optimizaciju tražilice- Glavna ideja koja stoji iza indeksiranja jest započeti s izvorne stranice i slijediti sve veze s tog izvora na druge stranice te stalno ponavljati isto"
            )
          )
          ul.appendChild(li3)
        }
      ...
      <div class="main" id="grid">
        ...
        <Grid container spacing={0} direction="column">
          <Grid
            item
            xs={12}
            style={{ maxWidth: "85%", margin: "auto", position: "relative" }}
          >
            <button
              type="button"
              class="button"
              id="1"
              onClick={visualizePathBFS}
            >
              BFS
            </button>
            <button
          ...
          >
            ...
            <button type="button" class="clear" onClick={clearPath}>
              CLEAR PATH
            </button>
